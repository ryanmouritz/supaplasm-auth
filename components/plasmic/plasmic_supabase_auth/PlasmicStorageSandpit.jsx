    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <TestDataProvider
            data-plasmic-name={"testStorageProvider"}
            data-plasmic-override={overrides.testStorageProvider}
            bucketName={"testBucket"}
            className={classNames("__wab_instance", sty.testStorageProvider)}
            instanceName={"Test Storage Provider"}
            ref={ref => {
              $refs["testStorageProvider"] = ref;
            }}
          >
            <DataCtxReader__>
              {$ctx => (
                <React.Fragment>
                  {(() => {
                    try {
                      return $ctx["Test Storage Provider"].isLoading;
                    } catch (e) {
                      if (
                  ...
                  {(() => {
                    try {
                      return $ctx["Test Storage Provider"].data;
                    } catch (e) {
                      if (
                        e instanceof TypeError ||
                        e?.plasmicType === "PlasmicUndefinedDataError"
                      ...
                      <React.Fragment>
                        {(() => {
                          try {
                            return (
                              "Response: " +
                              $ctx["Test Storage Provider"].data.fullPath
                            );
                          } catch (e) {
                            if (
                              e instanceof TypeError ||
                  ...
                  {(() => {
                    try {
                      return $ctx["Test Storage Provider"].error;
                    } catch (e) {
                      if (
                        e instanceof TypeError ||
                        e?.plasmicType === "PlasmicUndefinedDataError"
                    ...
                    >
                      <React.Fragment>
                        {(() => {
                          try {
                            return (
                              "Error: " + $ctx["Test Storage Provider"].error
                            );
                          } catch (e) {
                            if (
                              e instanceof TypeError ||
...
const PlasmicDescendants = {
  root: ["root", "navigationBar", "testStorageProvider"],
...
export const PlasmicStorageSandpit = Object.assign(
  ...
  makeNodeComponent("root"),
  {
    ...
    testStorageProvider: makeNodeComponent("testStorageProvider"),

...
const supabaseBrowserClient = async (
  ...
  if (!shouldSimulate) {
    ...
    if (
      ...
      throw new Error(
        "You have elected to simulate a logged in user for studio development. However you have not provided an email or password. Go to Project Settings -> SupabaseUser to fix."
      );

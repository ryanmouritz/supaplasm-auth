...
import { SupabaseStorageProvider } from "../../SupabaseStorageProvider"; // plasmic-import: Dd7FsMHlZFLF/codeComponent
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <SupabaseStorageProvider
            data-plasmic-name={"supabaseStorage"}
            data-plasmic-override={overrides.supabaseStorage}
            bucketName={"testBucket"}
            className={classNames("__wab_instance", sty.supabaseStorage)}
            instanceName={"supabaseStorage"}
            ref={ref => {
              $refs["supabaseStorage"] = ref;
            }}
          >
            <DataCtxReader__>
              {$ctx => (
                    ...
                    {(() => {
                      try {
                        ...
                        if (
                          ...
                          return "Supabase Storage Provider";
                        }
                        throw e;
                      }
                    })()}
          ...
          <Button
            ...
            onClick={async event => {
              const $steps = {};
              $steps["runActionOnSupabaseStorage"] = true
                ? (() => {
                    const actionArgs = {
                      tplRef: "supabaseStorage",
                      action: "uploadFile",
                      args: [
                        "1/2/3/newImage.jpg",
                ...
                : undefined;
              if (
                $steps["runActionOnSupabaseStorage"] != null &&
                typeof $steps["runActionOnSupabaseStorage"] === "object" &&
                typeof $steps["runActionOnSupabaseStorage"].then === "function"
              ) {
                $steps["runActionOnSupabaseStorage"] = await $steps[
                  "runActionOnSupabaseStorage"
                ];
              }
            }}
          />
...
const PlasmicDescendants = {
  root: ["root", "navigationBar", "supabaseStorage", "text", "button"],
  navigationBar: ["navigationBar"],
  supabaseStorage: ["supabaseStorage", "text"],
  text: ["text"],
  button: ["button"]
};
...
export const PlasmicStorageSandpit = Object.assign(
  ...
  makeNodeComponent("root"),
  {
    ...
    supabaseStorage: makeNodeComponent("supabaseStorage"),
